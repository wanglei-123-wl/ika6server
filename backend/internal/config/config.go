...
func Load() Config {
	...
	return Config{
		...
		MigrationsDir:     env("IKA6_MIGRATIONS_DIR", filepath.Join(root, "migrations")),
		AdminAccount:      os.Getenv("IKA6_ADMIN_ACCOUNT"),
		AdminPasswordHash: os.Getenv("IKA6_ADMIN_PASSWORD_HASH"),
